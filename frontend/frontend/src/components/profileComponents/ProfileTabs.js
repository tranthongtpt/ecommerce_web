      ...
      <form className="row  form-container" onSubmit={submitHandler}>
        ...
        <div className="col-md-6">
          <div className="form">
            ...
            <input className="form-control" required type="password" value={confirmpassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
          </div>
        </div>
        <button type="submit">Cập nhập thông tin</button>
      </form>
    </>
  );
};
